...
- AgentDojo port: publish how many attacks are rejected at compile time and how many normal tasks still succeed (utility). Banking done (`benchmarks/agentdojo`, decision 018): 16/16 tasks, 0/144 attacks past a careful approver; workspace, travel and Slack remain.
