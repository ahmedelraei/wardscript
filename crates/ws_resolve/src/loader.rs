...
use ws_syntax::Diagnostic;
use ws_syntax::ast::{ImportKind, Item};
use ws_syntax::diag::codes;
...
pub fn load(
    ...
    while next < modules.len() {
        ...
        let wanted: Vec<(usize, Vec<String>, ws_syntax::Span)> = modules[next]
            .ast
            .items
            .iter()
            .enumerate()
